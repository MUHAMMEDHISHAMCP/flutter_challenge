...
class ChartView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return expenses.isEmpty?  Center(
                  child: Text(
                    "No expenses yet",
      ...
      children: [
        SfCircularChart(
          legend: Legend(
            ...
            textStyle: Theme.of(context).textTheme.bodyMedium!.medium.s14.black,
          ),
          series: <CircularSeries>[
            PieSeries<ChartData, String>(
              ...
              dataSource: context.read<SummaryBloc>().calculateCategoryTotal(expenses),
        ...
        Padding(
          ...
          child: Text(
            ...
            style: Theme.of(context).textTheme.bodyMedium!.extraBold.s19.black,
          ),
        ),
        const Gap(8),
        Expanded(
